...
from sqlalchemy import Column, Integer, BigInteger, String, Sequence, TIMESTAMP, Boolean
...
class DBCommands:
    ...
    async def add_user(self, referral=None) -> User:
